...
var esvg = {
  ...
  icon: function(name, classnames) {
    ...
    if (element) {
      ...
      console.error('File not found: "'+name+'.svg" at app/assets/esvg/')
    }
  },
